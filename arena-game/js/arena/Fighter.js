...
export class Fighter {
  ...
  /**
   * Поднять бойца в стойку (NvN: правая модель — один «сфокусированный»
   * соперник; когда фокус переходит на нового живого врага, модель «оживает»,
   * чтобы не оставаться в позе падения от прошлого соперника).
   */
  revive() {
    this._tweens.length = 0;          // оборвать незавершённое падение
